...
switch ($_method) {
    ...
    case 'POST':
        if ($_autorizar === 'Bearer ipss.2025.T3') {
            ...
            $modelo->setSubtitulo($body->subtitulo);
            $modelo->setTextoboton($body->texto_boton);
            $modelo->setLinkboton($body->link_boton);
    ...
    case 'PUT':
        if ($_autorizar === 'Bearer ipss.2025.T3') {
            ...
            if ($anterior['subtitulo'] != $modelo->getSubtitulo()) {
                $cantidadCambios++;
            }
            if ($anterior['texto_boton'] != $modelo->getTextoboton()) {
                $cantidadCambios++;
            }
            if (strcmp($anterior['link_boton'], $modelo->getLinkboton())) {
                $cantidadCambios++;
            }
