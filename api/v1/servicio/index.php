...
switch ($_method) {
    ...
    case 'PUT':
        if ($_autorizar === 'Bearer ipss.2025.T3') {
            ...
            if ($anterior['precio'] != $modelo->getPrecio()) {
                $cantidadCambios++;
            }
            if ($anterior['descripcion'] != $modelo->getDescripcion()) {
                $cantidadCambios++;
            }
            if ($anterior['color_tema'] != $modelo->getColortema()) {
                $cantidadCambios++;
            }
            if ($anterior['detalles'] != $modelo->getDetalles()) {
                $cantidadCambios++;
            }
