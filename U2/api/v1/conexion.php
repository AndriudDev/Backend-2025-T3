...
class Conexion
{
    ...
    public function __construct()
    {
        ...
        CREATE DATABASE `coningen_ipss_back_25t3`;

        -- Crear el usuario y asignarle una contraseña
        CREATE USER 'coningen_ipss_back_25t3'@'localhost' IDENTIFIED BY '1pss_b4ck3nd';

        -- Asignar privilegios al usuario para la base de datos específica
        GRANT ALL PRIVILEGES ON `coningen_ipss_back_25t3`.* TO 'coningen_ipss_back_25t3'@'localhost';
        ...
        CREATE TABLE indicador(
            ...
            CONSTRAINT fk_indicador_unidad_medida
